...
<html>
    ...
    <body>
        ...
        <% String classifier_name = "none";
            ...
            <form name="admin" action="Control" method="post">
                 <div class="logmeout">
...
<select name="admin_classifer_choice" required>
                        <option value="------"> </option>
                        <option value="watches1"> Watches1 </option> 
                        <option value="watches2"> Watches2 </option> 
                       <option value="watches3"> Watches3 </option> 
                       <option value="watches4"> Watches4</option> 
                    </select> 
